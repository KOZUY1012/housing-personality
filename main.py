...
# ========== 결과 출력 ==========
    ...
    if result == "독립형":
        ...
        **추천 주거 형태:** 고시원, 원룸(전/월세), 풀옵션 오피스텔 (소형)
        """)
        st.image("/mnt/data/oneroom.png", caption="조용하고 아늑한 원룸의 모습", use_column_width=True)
        st.markdown("""
        **설명:**
    ...
    # 2) 공유형
        ...
        **추천 주거 형태:** 셰어하우스, 기숙사
        """)
        st.image("/mnt/data/sharehouse.png", caption="따뜻한 분위기의 셰어하우스 거실", use_column_width=True)
        st.markdown("""
        **설명:**
    ...
    # 3) 균형형
        ...
        **추천 주거 형태:** 다가구주택, 원룸빌라
        """)
        st.image("/mnt/data/Resident.png", caption="실용성과 감성을 동시에 갖춘 균형형 주거", use_column_width=True)
        st.markdown("""
        **설명:**
    ...
    # 4) 라이프형
        ...
        **추천 주거 형태:** 풀옵션 오피스텔, 신축 원룸, 주상복합
        """)
        st.image("/mnt/data/officetel.png", caption="감성적이고 세련된 오피스텔 내부", use_column_width=True)
        st.markdown("""
        **설명:**
